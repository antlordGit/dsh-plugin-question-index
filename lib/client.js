...
function QuestionIndexOverlay(props, sessions, jumpToQuestion) {
  ...
  async function confirmHandoff() {
    ...
    try {
      ...
      // already stored under that sessionId by terminal-tab's event bridge.
  ...
  return React.createElement('div', { className: 'qif-wrap', 'data-qi-root': '1' },
    handoffSessionId !== null ? React.createElement('div', { className: 'qif-handoffMask' },
      React.createElement('div', { className: 'qif-handoffDialog', role: 'dialog', 'aria-modal': 'true' },
        React.createElement('h3', { className: 'qif-handoffTitle' }, '交接'),
        ...
        React.createElement('label', { className: 'qif-handoffLabel' }, '智能体'),
        React.createElement('select', { className: 'qif-handoffSelect', value: handoffAgentId, onChange: function (event) { setHandoffAgentId(event.target.value) } },
          handoffAgents.map(function (agent) { return React.createElement('option', { key: agent.id, value: agent.id }, agent.name) })),
