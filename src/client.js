...
const CSS = [
  ...
  '@media(max-width:900px){.qif-popupShell{width:min(292px,calc(100vw - 92px))}}',
  ...
  /* ── 暗黑主题：问题索引原题弹框（沿用 handoff 对话框调色板） ── */
  'body[data-ds-dark-theme] .qif-popupShell{background:linear-gradient(145deg,#484b54,#30333a 42%,#25272c);box-shadow:0 18px 46px rgba(0,0,0,.56),0 3px 12px rgba(0,0,0,.38)}',
  'body[data-ds-dark-theme] .qif-popupShell::before{background:linear-gradient(90deg,transparent,rgba(255,255,255,.07),transparent)}',
  'body[data-ds-dark-theme] .qif-popup{background:#202226;color:#f1f2f4;box-shadow:inset 0 1px 0 rgba(255,255,255,.055)}',
  'body[data-ds-dark-theme] .qif-popupLabel{border-bottom-color:rgba(255,255,255,.08)}',
  'body[data-ds-dark-theme] .qif-popupText{scrollbar-color:rgba(255,255,255,.18) transparent}',
  'body[data-ds-dark-theme] .qif-popupText::-webkit-scrollbar-thumb{background:rgba(255,255,255,.18)}',
  'body[data-ds-dark-theme] .qif-popupText::selection{background:rgba(79,107,237,.28)}',
].join('')
...
function QuestionIndexOverlay(props, sessions, jumpToQuestion) {
  ...
  // 让 effect 仅在对话 tab 激活、stage 实际挂载时跑。
  React.useLayoutEffect(function () {
    ...
    const update = function () {
      let scroll = null
      try { scroll = document.querySelector('[data-conversation-scroll]') } catch (e) { scroll = null }
      if (scroll === null) { stage.style.removeProperty('left'); return }
